...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveTrainRobotDrive2Perpendicular.setInvertedMotor(RobotDrive.MotorType.kRearLeft, true);
        driveTrainRobotDrive2Perpendicular.setInvertedMotor(RobotDrive.MotorType.kRearRight, true);        
