...
public class FrontElevator extends Subsystem {
    ...
    SpeedController frontElevatorController = RobotMap.frontElevatorFrontElevatorController;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

	public ElevatorHelper eh = new ElevatorHelper(RobotMap.frontElevatorFrontElevatorController, 0.75, 0.125, 5, 2.0);
