...
public class OI {
    ...
    public JoystickButton controllerButton11;
    ...
    public OI() {
        ...
        controllerButton11 = new JoystickButton(controller, 11);
        controllerButton11.whileHeld(new PrintSwitchVoltage());
        ...
        manipulatorButton10.whileHeld(new DriveWest());
        ...
        joystickButton2.whileHeld(new EnableCreeperMode());
        ...
        SmartDashboard.putData("AllowPerpMovement", new AllowPerpMovement());

        SmartDashboard.putData("PrintSwitchVoltage", new PrintSwitchVoltage());

        SmartDashboard.putData("AutonDropBinArm", new AutonDropBinArm());

        SmartDashboard.putData("AutonLiftBinArm", new AutonLiftBinArm());

        SmartDashboard.putData("AutonDropRear", new AutonDropRear());

        SmartDashboard.putData("AutonDropFront", new AutonDropFront());

        SmartDashboard.putData("EnableCreeperMode", new EnableCreeperMode());
        
        SmartDashboard.putData("TestAutonCommands", new TestAutonCommands());

        SmartDashboard.putData("NoAutonPoints", new NoAutonPoints());

        SmartDashboard.putData("MoveBinAndToteToAutoZone", new MoveBinAndToteToAutoZone());

        SmartDashboard.putData("MoveRobotToAutoZone", new MoveRobotToAutoZone());

        SmartDashboard.putData("LiftBinAndGetCloseToDriver", new LiftBinAndGetCloseToDriver());
